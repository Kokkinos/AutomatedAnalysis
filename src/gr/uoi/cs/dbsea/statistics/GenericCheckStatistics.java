...
public class GenericCheckStatistics {
	...
	private HashMap<String,ArrayList<String>> AIs;
	...
	public GenericCheckStatistics() {
		...
		wordsToString = 0;
		this.AIs = new HashMap<String,ArrayList<String>>();
	}
	...
	public void addAis(String name,String rule) {
		if (this.AIs.containsKey(rule)) {
			
		} 
		else {
			ArrayList<String> adheredTablesColumnsPerRule = new ArrayList<String>();
			adheredTablesColumnsPerRule.add(name);
			this.AIs.put(rule, adheredTablesColumnsPerRule);
		}
